...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Register AP Invoice', href: '/purchase/ap/invoices/create' },
];
...
const form = useForm({
    ...
    purchase_order_id: '' as unknown as number,
...
const submit = () => {
    form.post('/purchase/ap/invoices');
};
</script>

<template>
    <Head title="Register AP Invoice" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="mx-auto flex w-full max-w-6xl flex-col gap-6 p-4">
            <div class="flex flex-wrap items-center justify-between gap-3">
                <Heading title="Register AP Invoice" description="Input invoice dari supplier berdasarkan barang yang sudah diterima." />
            ...
            <div class="rounded-lg border border-sidebar-border/70 p-4">
                <div class="mb-5 flex flex-wrap items-center gap-3 rounded-md bg-muted/40 px-3 py-2">
                    <span class="text-xs text-muted-foreground">AP Invoice Number (auto)</span>
                    <span class="font-mono text-sm font-semibold">{{ props.nextApInvoiceNumber }}</span>
                </div>
                ...
                <form class="space-y-5" @submit.prevent="submit">
                    <div class="grid gap-4 md:grid-cols-2">
                        <div class="grid gap-2">
                            ...
                            <p class="text-xs text-muted-foreground">Pilih PO untuk auto-fill supplier dan baris item dari barang yang sudah diterima.</p>
                        </div>
                    ...
                    <div class="flex justify-end gap-3">
                        ...
                        <Button type="submit" :disabled="form.processing">Save AP Invoice</Button>
                    </div>
                </form>
            </div>
        </div>
