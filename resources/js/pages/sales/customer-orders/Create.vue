...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Register CO', href: '/sales/customer-orders/create' },
];
...
const submit = () => {
    form.post('/sales/customer-orders');
};
</script>

<template>
    <Head title="Register Customer Order" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="mx-auto flex w-full max-w-6xl flex-col gap-6 p-4">
            <div class="flex flex-wrap items-center justify-between gap-3">
                <Heading title="Register Customer Order" description="Input CO baru, pilih customer, dan cek ketersediaan stok per line item." />
            ...
            <div class="rounded-lg border border-sidebar-border/70 p-4">
                ...
                <form class="space-y-5" @submit.prevent="submit">
                    ...
                    <div class="flex justify-end gap-3 pt-2">
                        ...
                        <Button type="submit" :disabled="form.processing">Save CO (Status: Registered)</Button>
                    </div>
                </form>
            </div>
        </div>
