...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Register Quotation', href: '/sales/quotations/create' },
];
...
<template>
    <Head title="Register Quotation" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="mx-auto flex w-full max-w-6xl flex-col gap-6 p-4">
            <div class="flex flex-wrap items-center justify-between gap-3">
                <Heading title="Register Quotation" description="Buat penawaran harga ke customer berdasarkan daftar part dan harga jual." />
            ...
            <div class="rounded-lg border border-sidebar-border/70 p-4">
                <div class="mb-5 flex flex-wrap items-center gap-3 rounded-md bg-muted/40 px-3 py-2">
                    <span class="text-xs text-muted-foreground">Quotation Number (auto)</span>
                    <span class="font-mono text-sm font-semibold">{{ nextQuotationNumber }}</span>
                </div>
