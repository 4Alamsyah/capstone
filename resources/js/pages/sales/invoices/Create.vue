...
const grandTotal = computed(() => {
    return subtotal.value + Number(form.tax_amount || 0);
});
                ...
                <form class="space-y-5" @submit.prevent="submit">
                    <div class="grid gap-4 md:grid-cols-2">
                        ...
                        <div class="grid gap-2">
                            ...
                            <Input id="tax_amount" v-model="form.tax_amount" type="number" min="0" step="any" />
                    ...
                    <div class="rounded-md border border-sidebar-border/70 bg-muted/30 p-3 text-sm">
                        ...
                        <div class="flex items-center justify-between py-1">
                            ...
                            <span class="font-mono">{{ Number(form.tax_amount || 0).toLocaleString() }} {{ form.currency_code || props.defaultCurrency }}</span>
                        </div>
